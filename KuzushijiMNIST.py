...
def get_labels(labels):
    """Return text labels for Kuzushiji MNIST labels."""
    text_labels = ['Character 0', 'Character 1', 'Character 2', 'Character 3', 'Character 4',
                   'Character 5', 'Character 6', 'Character 7', 'Character 8', 'Character 9']
    return [text_labels[int(i)] for i in labels]


def load_data(batch_size, resize=None):
    """Download Kuzushiji MNIST training and test datasets."""
